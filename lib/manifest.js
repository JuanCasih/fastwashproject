(function () {
  ...
  window.__BRAND__ = {
    ...
    equipo: {
      ...
      colorPicker: {
        subtitle: "Elegí el color de tu equipo",
    ...
    autoservicio: {
      ...
      parrafos: [
        "Aspiradora, inflador de neumáticos y aromatizante en un solo equipo. Funciona las 24 horas sin operador, y capta también al cliente que solo pasa a aspirar o inflar sin lavar.",
