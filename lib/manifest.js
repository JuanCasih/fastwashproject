(function () {
  ...
  window.__BRAND__ = {
    ...
    hero: {
      title: "Lavado automático de alta capacidad para negocios con tránsito de autos",
      sub: "La M-LM535 es un puente de lavado con cepillos (roll-over) pensado para estaciones de servicio, concesionarias, lavaderos y cualquier espacio con buen tránsito vehicular.",
      stats: [
        { value: "8–16", unit: "autos por hora" },
        { value: "2,5–6", unit: "min por auto" },
        { value: "43", unit: "m² de espacio" }
      ],
    ...
    marquee: [
      "8 A 16 AUTOS POR HORA",
      "PUENTE DE LAVADO ROLL-OVER",
      "COMBO M-LM535 + TT-303",
    ...
    oportunidad: {
      ...
      perfiles: [
        ...
        "Concesionarias",
        "Lavaderos que quieren multiplicar su capacidad",
        "Playas de estacionamiento y cocheras",
        "Emprendedores con un terreno bien ubicado"
      ]
    },
